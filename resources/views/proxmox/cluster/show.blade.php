    ...
    <div class="justify-content-start px-3 py-3">
        ...
        <div class="card w-100 bg-dark text-white">
            <div class="card-header">
                <h3>Resumen del cluster</h3>
            </div>
            <div class="card-body">
                <h4 class="card-title">Nombre del cluster: {{ $cluster->name }}</h4>
                <div class="justify-content-center py-3">
                    <h5 class="card-text">Total RAM nodos: {{ round($totalRAM / 1073741824, 2) }} GB</h5>
                    <h5 class="card-text">Total RAM Asignado: {{ round($totalRAMQemu / 1073741824, 2) }} GB</h5>
                ...
                <div class= "justify-content-center py-3">
                    <h5 class="card-text">Total CPU nodos: {{ $totalCPU }}</h5>
                    <h5 class="card-text">Total CPU Asignado: {{ $totalCPUQemu }}</h5>
                ...
                <div class = "justify-content-center py-3">
                    <h5 class="card-text">Total Disco en cluster: {{ round($totalMaxDisk / 1099511627776, 2) }} TB</h5>
                    <h5 class="card-text">Total Disco Asignado: {{ round($totalDiskQemu / 1099511627776, 2) }} TB</h5>

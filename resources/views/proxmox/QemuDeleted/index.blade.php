...
@section('content')
    <div class= "justify-content-start px-3">
        ...
        <h2 class="text-center"><strong>VM Eliminadas Data</strong></h2>
       <div class="d-flex px-3">
         {{-- boton para exportar a excel --}}
        
        {{-- crear boton de eliminar QemuDeleteds en estado eliminado --}}
        {{-- <form class= "px-3"action="{{ route('proxmox.QemuDeleted.destroy') }}" method="POST">
            @csrf
            @method('DELETE')
        ...
        {{-- <form action="{{ route('proxmox.searchQemuDeleted') }}" method="GET">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($QemuDeleted -> mem == 0)
                                0%
                                @else
                            <div class="progress" style="width: 100px;" title="{{ round($QemuDeleted->mem / $QemuDeleted->maxmem, 4) * 100 }}%">
